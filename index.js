...
const start = async () => {
  ...
  const dropNumber = async (context) => {
    ...
    //console.clear();
      ...
      console.clear();
      console.log(gradient('red', 'blue')('💀Number Locking by @ YA55EN0💀 +' + ddi + number))
  ...
  console.log(gradient('black', 'black')('■'))
  console.log(gradient('black', 'black')('■'))
  let ddi = prompt(gradient('purple', 'cyan')('[+] ادخل رمز الدوله: '));
  let number = prompt(gradient('purple', 'cyan')('[+] اكتب الرقم الخاص بـك: '))
